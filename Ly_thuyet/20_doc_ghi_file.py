...
open_file = open(file=r"C:\Users\admin\OneDrive\Desktop\tin cơ sở\24174600062_Tran_Thuy_Duyen_DHKL18A2HN\Ly_thuyet\file_a.txt")
C:\Users\admin\OneDrive\Desktop\tin cơ sở\24174600062_Tran_Thuy_Duyen_DHKL18A2HN\Ly_thuyet\file_a.txt

Ly_thuyet\file_a.txt
...
#w; mở và ghi tệp tin (ghi đè), nếu tệp tin không tồn tại
#w+: đọc và ghi tệp tin (ghi đè), nếu tệp tin không tồn tại, tạo tệp tin mới
#a: mở và ghi vào cuối tệp tin, nếu tệp tin không tồn tại sẽ báo lỗi
...
write_file = open(file="Ly_thuyet\file_a.txt"),mode="w"
write_file.write("chuoi thong tin moi")
write_file.writelines(["dong 1\n", "dong 2\n", "dong 3"])
write_file.close()


with open(file="Ly_thuyet\file_a.txt", mode="r") as open_file:
...
with open(file="Ly_thuyet\file_a.txt", mode="w") as write_file:
